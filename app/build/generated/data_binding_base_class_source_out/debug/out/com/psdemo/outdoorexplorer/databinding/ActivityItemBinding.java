...
public final class ActivityItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView geofence;
  ...
  private ActivityItemBinding(@NonNull LinearLayout rootView, @NonNull CardView card,
      @NonNull ImageView geofence, @NonNull ImageView icon, @NonNull TextView title) {
  ...
  public static ActivityItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.geofence;
      ImageView geofence = ViewBindings.findChildViewById(rootView, id);
      if (geofence == null) {
        break missingId;
      }
      ...
      return new ActivityItemBinding((LinearLayout) rootView, card, geofence, icon, title);
    }
